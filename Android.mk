...
ifneq ($(filter dubai london, $(TARGET_DEVICE)),)
...
VULKAN_SYMLINK := $(TARGET_OUT_VENDOR)/lib/hw/vulkan.msm8953.so
$(VULKAN_SYMLINK): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating lib/hw/vulkan.msm8953.so symlink: $@"
	@mkdir -p $(dir $@)
	$(hide) ln -sf $(LIBGLES_MALI_LIBRARY) $@

VULKAN64_SYMLINK := $(TARGET_OUT_VENDOR)/lib64/hw/vulkan.msm8953.so
$(VULKAN64_SYMLINK): $(LOCAL_INSTALLED_MODULE)
	@echo "Creating lib64/hw/vulkan.msm8953.so symlink: $@"
	@mkdir -p $(dir $@)
